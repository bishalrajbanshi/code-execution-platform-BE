...
export class DynamicMessages {
  ...
  createOrUpdate(name: string): string {
    return `${name} created/updated successfully`;
  }

  fetchedMessage(name: string): string {
  ...
  updateMessage(name: string): string {
  ...
  doesNotExistMessage(name: string): string {
    return `${name} does not exist`;
  }

  alreadyExistMessage(name: string): string {
